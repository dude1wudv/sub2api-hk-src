...
- **Batch Image** - Gemini and Vertex asynchronous batch-image workflow with Redis coordination and PostgreSQL state ([Operator Guide](docs/BATCH_IMAGE_MVP.md))
- **Async Image Tasks** - OpenAI-compatible image tasks backed by object storage to avoid long-lived proxy connections ([Operator Guide](docs/ASYNC_IMAGE_TASKS.md))
