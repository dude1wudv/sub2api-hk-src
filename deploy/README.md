...
curl -sSL https://raw.githubusercontent.com/dude1wudv/sub2api-hk-src/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/dude1wudv/sub2api-hk-src/releases)
