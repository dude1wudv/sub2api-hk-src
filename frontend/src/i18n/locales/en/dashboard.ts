export default {
  ...
  usage: {
    ...
    cacheReadRateShort: 'Cache',
    cacheReadRateFormula: 'Cache read ÷ (input + cache creation + cache read)',
    outputTps: 'Output-phase TPS',
    outputTpsShort: 'Output',
    outputTpsFormula: 'Output tokens ÷ (total duration − time to first token); unavailable without first-token data',
    overallTps: 'Overall average TPS',
    overallTpsShort: 'Overall',
    overallTpsFormula: 'Output tokens ÷ total duration, including pre-output waiting and reasoning time',
