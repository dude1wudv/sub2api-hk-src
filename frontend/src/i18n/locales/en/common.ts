export default {
  console: {
    ...
    analytics: {
      ...
      metric: 'Chart metric',
      userOverview: 'Balance, API keys, and usage at a glance.',
      adminOverview: 'Platform resources, traffic, and costs.',
      usageOverview: 'Analyze consumption and inspect individual requests.',
    ...
    access: {
      ...
      accessDescription: 'Sign in to manage your API access and account.',
      keysTitle: 'API keys',
      keysDescription: 'Create and manage keys for your applications.',
      usageTitle: 'Usage and costs',
      usageDescription: 'Review request usage, token consumption and spending.',
    ...
    pageNotFoundDescription: 'This page does not exist or has moved. Return to your workspace to continue.',
    apiKeys: {
      createdTitle: 'API key created',
      createdWarning: 'Save this key now. This creation display will not be shown again.',
      copyKey: 'Copy key',
      close: 'Close',
    },
    settings: {
      ...
      leaveWarning: 'You have unsaved changes. Leave without saving?',
      section: {
        general: 'General',
        gateway: 'Gateway',
        billing: 'Billing',
