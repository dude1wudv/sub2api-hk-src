export default {
  ...
  payment: {
    ...
    manual: {
      ...
      qrAlt: 'Alipay collection QR code',
      exactAmountHint: 'Scan with Alipay and pay the exact amount below. An administrator will confirm the receipt.',
    },
    orders: {
      title: 'My Orders',
      empty: 'No orders yet',
    ...
    balancePurchaseSuccess: 'Subscription purchased with your balance',
    balancePurchaseRefreshFailed: 'Your purchase succeeded, but balance or subscription status could not be refreshed. Please refresh later.',
    ...
    renewNow: 'Renew',
    fixedExpiresAt: 'Fixed expiry: {time}',
    saleEndsAt: 'Available until: {time}',
    selectPlan: 'Select Plan',
    planFeatures: 'Features',
    planCard: {
      onePurchaseOnly: 'One purchase only',
      onePurchaseOnlyHint: 'Each user can purchase this plan only once',
      alreadyPurchased: 'Purchased',
      alreadyPurchasedHint: 'Each user can purchase this plan only once.',
    ...
    perYear: 'year',
    admin: {
      confirmManualReceipt: 'Confirm receipt',
      manualReceiptAmountPrompt: 'Enter the amount received',
      manualReceiptConfirmed: 'Manual receipt confirmed',
      purchaseMode: 'Purchase method',
      purchaseModes: { external: 'Online payment', balance: 'Balance only', both: 'Both methods' },
      saleEndsAt: 'Sale end time',
      fixedExpiresAt: 'Fixed expiry time',
      onePurchasePerUser: 'Limit to one purchase per user',
      tabs: {
        overview: 'Overview',
        orders: 'Orders',
        channels: 'Channels',
