export default {
  ...
  dashboard: {
    ...
    balance: '余额',
    dailyBalance: '每日余额',
    dailyBalanceExpiring: '即将过期',
    daysRemaining: '{days}天后',
    hoursRemaining: '{hours}小时后',
    expiresIn: '剩余',
    noDailyBalance: '暂无每日余额',
    apiKeys: 'API 密钥',
    todayRequests: '今日请求',
    todayCost: '今日消费',
  ...
  usage: {
    ...
    tokenIncentive: {
      ...
      claimable: '可领取',
      description:
        '本周期累计消耗 Token 达到档位后，可领取对应奖励余额。奖励需在本周期内领取，过期不可补领。仅指定服务分组的用量计入激励，其它分组不计入。',
      refresh: '刷新',
      loading: '加载激励进度中...',
      periodUsed: '本周期已消耗',
      currentTarget: '当前目标',
      claimableBalance: '可领余额',
      progress: '本期进度',
      remaining: '还差 {tokens}',
      allReached: '已达成全部目标',
      periodEnds: '周期结束：{time}',
      claim: '领取',
      claiming: '领取中...',
      status: {
        locked: '未达成',
  ...
  usageSummary: {
    title: '用量概览',
    description: '查看余额、今日消耗、模型分布和订阅状态。',
    viewRecords: '查看明细',
    balance: '账户余额',
    walletHint: '余额用于按量扣费请求。',
    todayCost: '今日消费',
    todayTokens: '今日 Token',
    realtime: '实时负载',
    requests: '次请求',
    ...
    trend: '消费趋势',
    lastSevenDays: '最近 7 天实际扣费',
    entitlements: '可用权益',
    apiKeys: '活跃密钥',
    concurrency: '并发额度',
    activeSubscriptions: '有效订阅',
    modelSpend: '模型消费',
    activeSubscriptionList: '订阅状态',
    daysLeft: '天剩余',
    expiresAt: '到期：',
    noUsageYet: '暂无用量数据',
  ...
  redeem: {
    ...
    successBalanceTitle: '余额已到账',
    successBalanceDesc: '本次到账 ${value}，当前余额 ${balance}。之后请求会从余额中按实际用量扣费。',
    successConcurrencyTitle: '并发额度已更新',
    successConcurrencyDesc: '本次增加 {value} 个并发额度，当前可用并发为 {concurrency}。',
    successSubscriptionTitle: '订阅权限已生效',
    successSubscriptionDesc: '已获得 {groupName} 访问权限，有效期 {days} 天。可在订阅页查看剩余时间和额度进度。',
    viewUsageSummary: '查看用量概览',
  ...
  admin: {
    ...
    users: {
      ...
      // 每日余额赠额
      grantDailyBalance: '发放每日余额',
      dailyBalanceAmount: '每日余额额度',
      dailyBalanceGroup: '专属分组',
      selectDailyGroup: '选择每日余额专属分组',
      dailyBalanceAmountPlaceholder: '输入发放金额（USD）',
      dailyBalanceAmountHint: '24小时有效，仅在选定的专属分组内消费',
      dailyBalanceGranted: '每日余额发放成功',
      failedToGrantDailyBalance: '每日余额发放失败',
      dailyGrants: '每日余额发放记录',
      dailyGrantsTip: '点击查看每日余额记录',
      viewDailyGrants: '查看每日余额',
      noDailyGrants: '暂无每日余额发放记录',
      noDailyBalanceGroups: '暂无每日余额专属分组',
      grantedAt: '发放时间',
      expiresAt: '过期时间',
      dailyGrantStatus: '状态',
      dailyGrantSource: '来源',
      dailyGrantRemaining: '剩余',
      dailyGrantAmount: '额度',
      columnAlwaysVisible: '该列固定显示，不可隐藏',
      // 平台用量明细（悬浮显示）
      platformBreakdown: '按平台拆分',
    ...
    groups: {
      ...
      timedDiscount: {
        title: '限时特价',
        hint: '开启后，仅在指定每日时间段内接受此分组的新请求。',
        startTime: '开始时间',
        endTime: '结束时间',
        windowHint: '按 Asia/Shanghai 判断，开始时间包含，结束时间不包含；窗口外新请求会被直接拒绝。'
      },
      imagePricing: {
        title: '图片生成计费',
    ...
    accounts: {
      ...
      columns: {
        ...
        userBillingRateMultiplier: '用户倍率',
        weight: '权重',
        status: '状态',
        schedulable: '调度',
        todayStats: '今日统计',
      ...
      status: {
        ...
        tempUnschedRemaining: '剩余 {time}',
        quotaRetryUntil: '限流至 {time}'
      },
      tempUnschedulable: {
        title: '临时不可调度',
        ...
        clearOnly: '仅清除临时不可调度',
        clearOnlyHint: '只清除临时不可调度状态，不会使 token 失效',
        clearOnlySuccess: '已清除临时不可调度',
        clearOnlyFailed: '清除临时不可调度失败',
        fullRecover: '完整恢复（含 token）',
      ...
      usageWindow: {
        ...
        grokTokens: 'Token',
        grokWeekly: '周额度',
        grokWeeklyNoData: '周额度暂无',
        grokWeeklyError: '周额度查询失败',
        grokRateLimitResume: '限流恢复：{time}',
        grokUnknown: 'Grok 配额需等待首次上游响应返回 xAI rate-limit 头后显示。',
        grokRetryAfter: '{time} 后重试',
        grokProbe: '探测',
        grokProbeTooltip: '探测短窗响应头与周额度（billing）',
      ...
      maintenance: {
        scanNow: '立即扫描 / 重平衡',
        scanNowShort: '扫描 / 重平衡',
        partitionRiskPool: '确认风险分池',
        partitionRiskPoolShort: '风险分池 {count}',
        riskAlerts: '账号风险告警',
        drain95: '95%+ {count}',
        exhausted99: '99%+ {count}',
        challenge: 'Challenge {count}',
        banned: '封禁 {count}',
        highFailure: '高失败 {count}',
        riskChallenge: 'Challenge',
        riskBanned: '封禁',
        riskHighFailure: '高失败',
        scanResult: '扫描完成：慢池 {slow}，正常池 {normal}',
        scanFailed: '扫描失败',
        partitionConfirm: '确认将 {count} 个 challenge / 封禁 / 高失败账号移动到最慢池？',
        partitionResult: '风险分池完成：移动 {moved}，已在慢池 {already}',
        partitionFailed: '风险分池失败'
      },
      grok: {
      ...
      userBillingRateMultiplier: '用户计费倍率',
      userBillingRateMultiplierHint: '叠加在分组倍率后影响用户扣费，例如分组 0.1 × 用户计费倍率 1.5 = 0.15',
      expiresAt: '过期时间',
  ...
  payment: {
    ...
    balancePurchaseSuccess: '购买成功，订阅已立即生效。',
    balancePurchaseRefreshFailed: '购买已成功，但余额或订阅状态刷新失败。',
    saleEndsAt: '售卖截止：{time}',
    noPlans: '暂无可用订阅套餐',
    notAvailable: '充值功能暂未开放',
    redeemCodeOnlyTitle: '联系管理员充值',
    ...
    errors: {
      ...
      SUBSCRIPTION_ALREADY_PURCHASED: '该订阅套餐每个账户仅限购买一次',
      SUBSCRIPTION_PURCHASE_IN_PROGRESS: '该订阅套餐已有正在处理的购买，请稍后重试',
    ...
    planCard: {
      ...
      onePurchaseOnlyHint: '每个账户仅可购买此套餐一次。',
    },
    days: '天',
    months: '个月',
    years: '年',
    ...
    admin: {
      ...
      purchaseMode: '购买方式',
      purchaseLimit: '购买限制',
      onePurchasePerUser: '每用户限购一次',
      onePurchasePerUserHint: '每个账户仅可购买此套餐一次。',
      onePurchaseOnly: '限购一次',
      unlimitedPurchases: '不限购',
      purchaseModes: {
        external: '外部支付',
        balance: '余额购买',
      },
      saleEndsAt: '售卖截止时间',
      saleEndsAtHint: '按 Asia/Shanghai 时间填写；留空表示不限时。',
      saleNeverEnds: '不限时',
      saleEnded: '已结束',
      onSale: '上架',
      offSale: '下架',
