export default {
  ...
  usage: {
    ...
    tokenIncentive: {
      ...
      claimable: 'Claimable',
      description:
        'Reach token thresholds in the current period to claim balance rewards. Rewards must be claimed before the period ends. Only usage from designated service groups counts toward the incentive; other groups do not.',
      refresh: 'Refresh',
      loading: 'Loading incentive progress...',
      periodUsed: 'Used this period',
      currentTarget: 'Current target',
      claimableBalance: 'Claimable balance',
      progress: 'Period progress',
      remaining: '{tokens} remaining',
      allReached: 'All targets reached',
      periodEnds: 'Period ends: {time}',
      claim: 'Claim',
      claiming: 'Claiming...',
      status: {
        locked: 'Locked',
    ...
    lifetimeUserBilled: 'Lifetime user billed',
    resetNow: 'Now',
  ...
  usageSummary: {
    title: 'Usage Summary',
    description: 'Check balance, today spend, model distribution, and subscriptions.',
    viewRecords: 'View records',
    balance: 'Balance',
    walletHint: 'Balance is deducted by actual API usage.',
    todayCost: 'Today cost',
    todayTokens: 'Today tokens',
    ...
    trend: 'Spend trend',
    lastSevenDays: 'Actual billed cost in the last 7 days',
    entitlements: 'Entitlements',
    apiKeys: 'Active keys',
    concurrency: 'Concurrency',
    activeSubscriptions: 'Active subscriptions',
    modelSpend: 'Model spend',
    activeSubscriptionList: 'Subscription status',
    daysLeft: 'days left',
    expiresAt: 'Expires: ',
  ...
  redeem: {
    ...
    successBalanceTitle: 'Balance credited',
    successBalanceDesc: '${value} was credited. Current balance is ${balance}. Future API calls will be billed from this balance by actual usage.',
    successConcurrencyTitle: 'Concurrency updated',
    successConcurrencyDesc: 'Added {value} concurrent requests. Current concurrency is {concurrency}.',
    successSubscriptionTitle: 'Subscription is active',
    successSubscriptionDesc: 'Access to {groupName} is active for {days} days. Check the subscription page for remaining time and quota progress.',
    viewUsageSummary: 'View usage summary',
  ...
  admin: {
    ...
    accounts: {
      ...
      summary: {
        ...
        error: 'Invalid',
        paused: 'Paused',
        codex5h: '5h Remaining',
        codex7d: 'Weekly Remaining',
        sampled: 'Sample {count}',
        used: 'Used {percent}',
        exhausted: 'Exhausted {count}',
        proxyTitle: 'Proxy Pool',
        openaiAccounts: 'OpenAI accounts',
        tokyoPool: 'Tokyo nodes',
        accounts: 'Accounts',
        usable: 'Usable',
        latency: 'Latency',
      ...
      status: {
        ...
        tempUnschedRemaining: 'Remaining {time}',
        quotaRetryUntil: 'Rate limited until {time}'
      },
      columns: {
        name: 'Name',
        id: 'Account ID',
        ...
        userBillingRateMultiplier: 'User Rate',
        weight: 'Weight',
        status: 'Status',
        schedulable: 'Schedulable',
      ...
      tempUnschedulable: {
        ...
        description: 'Description',
        clearOnly: 'Clear temp unschedulable only',
        clearOnlyHint: 'Clears temp unschedulable without invalidating the token',
        clearOnlySuccess: 'Temp unschedulable cleared',
        clearOnlyFailed: 'Failed to clear temp unschedulable',
        fullRecover: 'Full recover (incl. token)',
      ...
      maintenance: {
        scanNow: 'Scan / Rebalance Now',
        scanNowShort: 'Scan / Rebalance',
        partitionRiskPool: 'Confirm Risk Pooling',
        partitionRiskPoolShort: 'Risk Pool {count}',
        riskAlerts: 'Account Risk Alerts',
        drain95: '95%+ {count}',
        exhausted99: '99%+ {count}',
        challenge: 'Challenge {count}',
        banned: 'Banned {count}',
        highFailure: 'High failure {count}',
        riskChallenge: 'Challenge',
        riskBanned: 'Banned',
        riskHighFailure: 'High failure',
        scanResult: 'Scan complete: slow pool {slow}, normal pool {normal}',
        scanFailed: 'Scan failed',
        partitionConfirm: 'Move {count} challenge / banned / high-failure accounts to the slowest pool?',
        partitionResult: 'Risk pooling complete: moved {moved}, already in slow pool {already}',
        partitionFailed: 'Risk pooling failed'
      },
      grok: {
      ...
      userBillingRateMultiplier: 'User Billing Multiplier',
      userBillingRateMultiplierHint: 'Stacks after the group multiplier for user charges. Example: group 0.1 × user multiplier 1.5 = 0.15',
      expiresAt: 'Expires At',
      ...
      usageWindow: {
        ...
        grokTokens: 'Tok',
        grokWeekly: 'Weekly',
        grokWeeklyNoData: 'Weekly quota unavailable',
        grokWeeklyError: 'Weekly quota probe failed',
        grokRateLimitResume: 'Rate-limit resume: {time}',
        ...
        grokProbe: 'Probe',
        grokProbeTooltip: 'Probe short-window headers and weekly billing quota',
  ...
  payment: {
    ...
    balancePurchaseSuccess: 'Purchase complete. Your subscription is active now.',
    balancePurchaseRefreshFailed: 'Purchase succeeded, but the balance or subscription status could not be refreshed.',
    saleEndsAt: 'Sale ends: {time}',
    noPlans: 'No subscription plans available',
    notAvailable: 'Top-up is currently unavailable',
    redeemCodeOnlyTitle: 'Contact admin to recharge',
    ...
    admin: {
      ...
      onePurchasePerUser: 'One purchase per user',
      onePurchasePerUserHint: 'Each account can purchase this plan only once.',
      onePurchaseOnly: 'One purchase only',
      ...
      saleEndsAt: 'Sale End Time',
      saleEndsAtHint: 'Enter Asia/Shanghai time; leave blank for no deadline.',
      saleNeverEnds: 'No deadline',
      saleEnded: 'Ended',
      onSale: 'On Sale',
      offSale: 'Off Sale',
      group: 'Group',
