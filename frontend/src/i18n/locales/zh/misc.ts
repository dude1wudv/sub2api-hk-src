export default {
  ...
  payment: {
    ...
    manual: {
      title: '支付宝扫码付款',
      qrAlt: '支付宝收款码',
      exactAmountHint: '请使用支付宝扫码，并严格支付下方金额。到账后由管理员确认。',
    },
    orders: {
      title: '我的订单',
      empty: '暂无订单',
    ...
    balancePurchaseSuccess: '已使用余额完成订阅购买',
    balancePurchaseRefreshFailed: '购买已完成，但余额或订阅状态刷新失败，请稍后刷新页面。',
    groupFallback: '分组 #{id}',
    ...
    subscribeNow: '立即开通',
    renewNow: '续费',
    fixedExpiresAt: '固定到期：{time}',
    saleEndsAt: '限时售卖至：{time}',
    selectPlan: '选择套餐',
    planFeatures: '功能特性',
    planCard: {
      onePurchaseOnly: '限购一次',
      onePurchaseOnlyHint: '每位用户仅可购买一次',
      alreadyPurchased: '已购买',
      alreadyPurchasedHint: '该套餐每位用户仅可购买一次。',
      totalLimit: '总额度',
      rate: '倍率',
      peakRate: '高峰倍率',
      dailyLimit: '日限额',
    ...
    perYear: '年',
    admin: {
      confirmManualReceipt: '确认到账',
      manualReceiptAmountPrompt: '请输入实际到账金额',
      manualReceiptConfirmed: '手工到账已确认',
      purchaseMode: '购买方式',
      purchaseModes: { external: '在线支付', balance: '余额购买', both: '两种方式均可' },
      saleEndsAt: '限时售卖截止时间',
      fixedExpiresAt: '固定到期时间',
      onePurchasePerUser: '每人限购一次',
      tabs: {
        overview: '概览',
        orders: '订单管理',
        channels: '支付渠道',
