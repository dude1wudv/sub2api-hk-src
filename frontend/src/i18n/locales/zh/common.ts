export default {
  console: {
    ...
    analytics: {
      ...
      activity: 'API 活动',
      metric: '图表指标',
      userOverview: '查看余额、API 密钥与用量。',
      adminOverview: '平台资源、流量与成本。',
      usageOverview: '分析用量并查看请求明细。',
      filterName: '筛选名称',
    },
    logs: {
      method: '方法',
    ...
    searchPages: '搜索页面…',
    noPages: '没有匹配的页面',
    commandHint: '↑ ↓ 选择 · Enter 打开 · Esc 关闭',
    breadcrumb: '面包屑导航',
    access: {
      accessTitle: '工作区入口',
      accessDescription: '登录后管理 API 访问与账户。',
      keysTitle: 'API 密钥',
      keysDescription: '为应用创建和管理 API 密钥。',
      usageTitle: '用量与费用',
      usageDescription: '查看请求用量、Token 消耗与费用。',
      accountTitle: '账户设置',
      accountDescription: '管理个人资料与登录安全。',
    },
    table: {
      savedFilters: '已保存筛选',
      saveFilter: '保存筛选',
    ...
    toggleKeyVisibility: '显示或隐藏 API 密钥',
    pageNotFoundDescription: '此页面不存在或已移动。请返回工作区继续操作。',
    apiKeys: {
      createdTitle: 'API 密钥已创建',
      createdWarning: '请立即保存此密钥。此创建提示不会再次显示。',
      copyKey: '复制密钥',
      close: '关闭',
    },
    settings: {
