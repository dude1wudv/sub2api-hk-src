    ...
    <div class="space-y-6">
      ...
      <div class="border-b border-primary-500/15 pb-6 text-left">
        <div class="mb-5 flex items-center gap-3 text-primary-600 dark:text-primary-300" aria-hidden="true">
          <span class="flex h-10 w-10 items-center justify-center rounded-lg border border-primary-500/25 bg-primary-500/10"><Icon name="login" size="md" /></span>
        ...
        <div>
          ...
          <div class="relative">
            ...
            <button
              ...
              class="absolute inset-y-0 right-0 flex min-h-[44px] min-w-[44px] items-center justify-center text-gray-400 transition-colors hover:text-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500/40 dark:text-dark-300 dark:hover:text-dark-100"
            >
