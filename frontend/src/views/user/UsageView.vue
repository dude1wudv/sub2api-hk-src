...
function restoreUsageQuery(value: Record<string, unknown>) {
  const { start_date, end_date, sort_by, sort_order, page, page_size, granularity: savedGranularity, error_page, error_page_size, error_sort_by, error_sort_order, error_model, error_category, error_api_key_id, status_code, error_phase: _errorPhase, ...savedFilters } = value
