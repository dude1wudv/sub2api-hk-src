  ...
  <header class="glass sticky top-0 z-30 border-b">
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex min-w-0 flex-1 items-center gap-2 sm:gap-4">
        ...
        <div class="min-w-0">
          <h1 class="truncate text-base font-semibold tracking-tight text-gray-900 dark:text-white sm:text-lg" :title="pageTitle">
            {{ pageTitle }}
          </h1>
          <p v-if="pageDescription" class="hidden truncate text-xs text-gray-500 dark:text-dark-300 lg:block">
            {{ pageDescription }}
          </p>
        </div>
      </div>
