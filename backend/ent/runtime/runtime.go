...
func init() {
	...
	// accountDescUserRateMultiplier is the schema descriptor for user_rate_multiplier field.
	accountDescUserRateMultiplier := accountFields[12].Descriptor()
	// account.DefaultUserRateMultiplier holds the default value on creation for the user_rate_multiplier field.
	account.DefaultUserRateMultiplier = accountDescUserRateMultiplier.Default.(float64)
	...
	groupDescSpendingUsedUsd := groupFields[38].Descriptor()
	...
	groupDescDailyBalanceEnabled := groupFields[39].Descriptor()
	...
	groupDescDailyFallbackMultiplier := groupFields[40].Descriptor()
	...
	groupDescTimedDiscountEnabled := groupFields[41].Descriptor()
	...
	groupDescTimedDiscountStartMinute := groupFields[42].Descriptor()
	...
	groupDescTimedDiscountEndMinute := groupFields[43].Descriptor()
	...
	subscriptionplanDescPurchaseMode := subscriptionplanFields[9].Descriptor()
	...
	subscriptionplanDescOnePurchasePerUser := subscriptionplanFields[10].Descriptor()
