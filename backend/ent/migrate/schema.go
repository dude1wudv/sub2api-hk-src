...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "user_rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "spending_limit_usd", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,8)"}},
