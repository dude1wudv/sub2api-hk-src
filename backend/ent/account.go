...
type Account struct {
	...
	// UserRateMultiplier holds the value of the "user_rate_multiplier" field.
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldRateMultiplier, account.FieldUserRateMultiplier:
...
func (_m *Account) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case account.FieldUserRateMultiplier:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field user_rate_multiplier", values[i])
			} else if value.Valid {
				_m.UserRateMultiplier = value.Float64
			}
...
func (_m *Account) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("user_rate_multiplier=")
	builder.WriteString(fmt.Sprintf("%v", _m.UserRateMultiplier))
	builder.WriteString(", ")
