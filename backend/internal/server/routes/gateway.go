...
func RegisterGatewayRoutes(
	...
	isOpenAIResponsesCompatibleGatewayPlatform := func(c *gin.Context) bool {
		...
		case service.PlatformOpenAI, service.PlatformGrok,
			...
			service.PlatformMiniMax, service.PlatformStepFun, service.PlatformOpenCodeGo, service.PlatformMirasim:
	...
	countTokensHandler := func(c *gin.Context) {
		switch getGroupPlatform(c) {
		case service.PlatformOpenAI, service.PlatformKimi, service.PlatformZhipu, service.PlatformDeepseek, service.PlatformMiniMax, service.PlatformStepFun, service.PlatformOpenCodeGo, service.PlatformMirasim:
	...
	// Native Qwen audio endpoints use a dedicated 8 MiB request limit and the
	// OpenAI-compatible group-assignment error envelope.
