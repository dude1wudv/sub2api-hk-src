...
var (
	...
	ErrChannelMonitorInvalidAccountID = infraerrors.BadRequest(
		"CHANNEL_MONITOR_INVALID_ACCOUNT_ID", "account_id must be a positive integer; 0 is only valid as an update clear sentinel",
	)
