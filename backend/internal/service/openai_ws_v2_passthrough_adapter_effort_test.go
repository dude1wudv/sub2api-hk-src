...
func TestWSPassthroughUsageMeta_InitFromFirstFrame_NonGPT56KeepsMax(t *testing.T) {
	...
	require.Equal(t, "max", *got, "max/ultra must pass through as-is on non-5.6 models too")
}
