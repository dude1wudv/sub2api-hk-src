...
func TestBuildGrokResponsesRequestUsesAccountBaseURLAndBearerToken(t *testing.T) {
	...
	require.Equal(t, xai.GrokCLIResponsesUserAgent, req.Header.Get("User-Agent"))
	require.Equal(t, xai.TokenAuthCLI, req.Header.Get("X-XAI-Token-Auth"))
	require.Equal(t, xai.GrokCLIAuthenticateResponse, req.Header.Get("X-AuthenticateResponse"))
	require.Equal(t, xai.GrokCLIClientName, req.Header.Get("X-Grok-Client-Name"))
	require.Equal(t, xai.GrokCLIClientVersion, req.Header.Get("X-Grok-Client-Version"))
	require.Equal(t, xai.GrokCLIClientIdentifier, req.Header.Get("X-Grok-Client-Identifier"))
	require.Equal(t, xai.GrokCLIClientSurface, req.Header.Get("X-Grok-Client-Surface"))
