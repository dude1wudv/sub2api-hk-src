...
func (s *OpenAIGatewayService) forwardResponsesViaRawChatCompletions(
	...
	// custom tools (e.g. Codex exec) degrade to function tools; restore on return.
	// tool_search and namespace child tools likewise need name maps for restore.
	...
	if normalizedBody, changed, normalizeErr := normalizeOpenAIChatReasoningEffortBody(chatBody); normalizeErr != nil {
...
func (s *OpenAIGatewayService) bufferChatCompletionsAsResponses(
	...
	return &OpenAIForwardResult{
		...
		UpstreamEndpoint: openAIChatCompletionsUpstreamEndpoint,
